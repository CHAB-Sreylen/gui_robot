...
class MyGUI:
    def __init__(self):
        ...
        # Create buttons
        self.button_connected = tk.Button(self.root, text="Connected", command=self.toggle_button1, bg="blue", font=('Times 30'), fg='white')
        self.button_connected.grid(row=0, column=0, padx=30, pady=50, sticky="nsew")

        self.button_blue = tk.Button(self.root, text="Blue Team", command=self.toggle_button2, bg="blue", font=('Times 30'), fg='white')
        ...
        self.label_location = tk.Label(self.frame_location, text="Location", bg='#3c3f44', font=('Times 30'), fg='yellow')
        ...
        self.label_sensor = tk.Label(self.frame_sensor, text="Sensor Camera:", bg='#3c3f44', font=('Times 30'), fg='yellow')
